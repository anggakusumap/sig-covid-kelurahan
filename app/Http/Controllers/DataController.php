...
class DataController extends Controller
{
    ...
    public function index()
    {
        ...
        $kelurahan_belum_diupdate = Kelurahan::whereDoesntHave('data', function($query){
            $query->where('tanggal','=',$this->dateNow)->where('status','=',1);
        })->get();
        return view('data.index', compact("kabupaten","kelurahan_belum_diupdate","tanggal_saat_ini"));
    }
